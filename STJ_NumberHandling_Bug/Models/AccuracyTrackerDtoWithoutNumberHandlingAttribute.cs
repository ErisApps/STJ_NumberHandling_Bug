...
public readonly struct AccuracyTrackerDtoWithoutNumberHandlingAttribute
{
	...
	[JsonConstructor]
	public AccuracyTrackerDtoWithoutNumberHandlingAttribute(double accRight, double accLeft, double averageAcc, double leftSpeed, double rightSpeed, double averageSpeed, double leftHighestSpeed,
		double rightHighestSpeed,
