...
public readonly struct AccuracyTrackerDtoWithNumberHandlingAttribute
{
	...
	[JsonConstructor]
	public AccuracyTrackerDtoWithNumberHandlingAttribute(double accRight, double accLeft, double averageAcc, double leftSpeed, double rightSpeed, double averageSpeed, double leftHighestSpeed,
